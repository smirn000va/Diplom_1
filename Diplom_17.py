...
def main():
    ...
    with open('data_copy.csv', 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            users = tools.get_all('users.search', 1000, values={'q': search_string, 'birth_day': data_search_birthday.day, 'birth_month': data_search_birthday.month, 'fields': ['bdate', 'contacts', 'city', 'connections', 'followers_count']})
